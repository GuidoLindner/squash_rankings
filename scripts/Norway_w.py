...
def get_top5():
    api_url_base = "https://api.rankedin.com/v1/Ranking/GetRankingsAsync?rankingId=82&rankingType=2&ageGroup=13"
    ranking_date = get_latest_monday()
    api_url = f"{api_url_base}&rankingDate={ranking_date}&weekFromNow=0&language=nl&skip=0&take=10&_=1756197403970"
