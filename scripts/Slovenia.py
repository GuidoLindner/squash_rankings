...
def get_top5():
    api_url_base = "https://api.rankedin.com/v1/Ranking/GetRankingsAsync?rankingId=1283&rankingType=1&ageGroup=1"
    
    try:
        ranking_date, week, year = get_latest_monday()
        api_url = f"{api_url_base}&rankingDate={ranking_date}&weekFromNow=0&language=si&skip=0&take=10&_=1755430116005"
