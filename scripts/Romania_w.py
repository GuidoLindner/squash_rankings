...
def get_top5():
    api_url_base = "https://api.rankedin.com/v1/Ranking/GetRankingsAsync?rankingId=6006&rankingType=2&ageGroup=13"
    try:
        ranking_date, week, year = get_latest_monday()
        api_url = f"{api_url_base}&rankingDate={ranking_date}&weekFromNow=8&language=en&skip=0&take=10&_=1756197777707"
